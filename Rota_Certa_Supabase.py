...
ARQUIVO_LIMITE = Path(r"D:\kidy_suite\preditiva\DADOS PRDITIVA LIMITE.xlsx")
...
def autenticar_usuario_supabase():
    ...
    if not st.session_state["autenticado"]:
        st.markdown("## 🔐 Acesso — Rota Campeã")
...
st.sidebar.caption(f"✅ Limite: {ARQUIVO_LIMITE}")
